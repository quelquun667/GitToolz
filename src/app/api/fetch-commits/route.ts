import { fetchCommitsAction } from '@/app/actions';
...
export async function POST(request: Request) {
  try {
    ...
    const result = await fetchCommitsAction({ repoUrl, branch, startDate, endDate });
    ...
    console.error('API Error in fetch-commits:', error);
