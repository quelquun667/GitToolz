import { getBranchActivityAction } from '@/app/actions';
...
export async function POST(request: Request) {
  try {
    ...
    const result = await getBranchActivityAction({ repoUrl, branch });
    ...
    console.error('API Error in get-branch-activity:', error);
