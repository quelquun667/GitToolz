import { getContributorStatsAction } from '@/app/actions';
...
export async function POST(request: Request) {
  try {
    ...
    const result = await getContributorStatsAction({ repoUrl, branch });
    ...
    console.error('API Error in get-contributor-stats:', error);
